	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'hearth' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'hearth' ); ?></th>
			</tr>
		</thead>
		<tbody>
